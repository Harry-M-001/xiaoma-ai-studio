...
register(
    TableSpec(
        ...
        seed=[
            ...
            # ---- 在线更新 ----
            {"key": "update.repo", "group_name": "update", "label": "更新源仓库", "value_type": "string",
             "value": "", "sort_order": 41,
             "description": "形如 用户名/仓库名。填写后「关于与更新」才能检查新版本；发布到 GitHub 与 Gitee 时填同一个仓库名即可"},
            {"key": "update.source", "group_name": "update", "label": "更新源", "value_type": "string",
             "value": "gitee", "sort_order": 42,
